...
include { MMSEQS_FILTERTAXDB   } from '../../modules/local/mmseqs_filtertaxdb'
include { MMSEQS_CREATESUBDB   } from '../../modules/local/mmseqs_createsubdb'
include { MMSEQS_CONVERT2FASTA } from '../../modules/local/mmseqs_convert2fasta'
